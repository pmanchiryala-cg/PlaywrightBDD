...
- BDD features: [tests/features](tests/features)
  - UI: [tests/features/ui/userlogin.feature](tests/features/ui/userlogin.feature), [tests/features/ui/multiplelogins.feature](tests/features/ui/multiplelogins.feature)
...
- Step definitions: [tests/steps](tests/steps)
  - UI steps: [`userlogin.steps`](tests/steps/ui/userlogin.steps.js), [`multiplelogins.steps`](tests/steps/ui/multiplelogins.steps.js)
...
Run single test
npx playwright test tests/runners/tests/features/ui/multiplelogins.feature.spec.js

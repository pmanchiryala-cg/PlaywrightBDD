...
test.describe('Validate SF EAPI Health Check Endpoint', () => {
  ...
  test('Successful response for Health check endpoint', async ({ Given, When, Then, request }) => { 
    ...
    await Then('SF_EAPI should return a 200 OK response'); 
  });

// Generated from: tests\features\api\sf_eapi1_POST_EPC_request.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\api\\sf_eapi1_POST_EPC_request.feature'), { scope: 'test', box: true }],

// Generated from: tests\features\api\sf_eapi_POST_EPC_request1.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\api\\sf_eapi_POST_EPC_request1.feature'), { scope: 'test', box: true }],
